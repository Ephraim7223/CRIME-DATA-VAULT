...
const criminalSchema = new mongoose.Schema(
  {
    ...
    contactLine: { type: String, required: true, default: ' ' },
    ...
    Contactfirstname: { type: String, required: true, default: ' ' },
    Contactmiddlename: { type: String, required: true, default: ' ' },
    Contactlastname: { type: String, required: true, default: ' ' },
    contactNumber: { type: String, required: true, default: ' ' },
    contactaddress: { type: String, required: true, default: ' ' },
    contactRelationship: { type: String, required: true, default: ' ' },
    crime: { type: String, required: true },
    dateCommitted: { type: String, required: true, default: ' ' },
    dateConvicted: { type: String, required: true, default: ' ' },
    correctionalCenter: { type: String, required: true, default: ' ' },
    sentence: { type: String, required: true, default: ' ' },
